...
{
    public partial class F_LoHattyu : Form
    {
        F_LoMenu LoMenu;
        ...
        public F_LoHattyu(F_LoMenu loMenu, string ID, string Name)
        {
            InitializeComponent();
            LoMenu = loMenu;
            Text = "発注管理";
        ...
        private void lblDetailPageNo_Click(object sender, EventArgs e)
        {

        }

        private void cbxLink_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void lblDetailPageSize_Click(object sender, EventArgs e)
        {
        ...
        private void lblWaQuantity_Click(object sender, EventArgs e)
        {

        }

        private void lblWaQuantityValue_Click(object sender, EventArgs e)
        {

        }

        private void lblOrQuantity_Click(object sender, EventArgs e)
        {

        }

        private void lblOrQuantityValue_Click(object sender, EventArgs e)
        {

        }

        private void lblSafetyStock_Click(object sender, EventArgs e)
        {
        ...
        private void lblStockValue_Click(object sender, EventArgs e)
        {
